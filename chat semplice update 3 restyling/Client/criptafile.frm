...
Begin VB.Form criptafile 
   ...
   Begin client.CandyButton cmdCrypt 
      Height          =   375
      Left            =   2280
      TabIndex        =   2
      Top             =   600
   ...
   End
End
Attribute VB_Name = "criptafile"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
' questo codice e' fatto da sandro professional programmer'
Option Explicit
...
Private Sub cmdchiudi_Click()
 criptafile.Visible = False
End Sub

Private Sub cmdCrypt_Click()
cryptFile
MsgBox "criptaggio completato!"
End Sub
