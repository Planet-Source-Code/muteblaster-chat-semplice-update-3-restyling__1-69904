...
' Purpose   : An easy acceess to Stystem Tray
' Advantage : Fully functional with minimal code
'---------------------------------------------------------------------
' You are free to use this code in any of ur codes
' Feel free to email me if u have any questions
'---------------------------------------------------------------------
...
Public Enum ModifyItemEnum
    Tray_ToolTip = 1             'Modify ToolTip
    Tray_Icon = 2                'Modify Icon
End Enum
